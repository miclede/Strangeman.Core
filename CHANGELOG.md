...
* Bug fixes, comment changes, refactoring.
* Evaluation with Predicates
* State Machine with Transitions
* New Input system mapping and scriptable objects
* Interaction Registry
* ScriptableActions using Visitor Pattern
* Observable Properties with pull and push style approaches
