...
namespace Strangeman.Editor
{
    ...
    public class StaticFieldClearer
    {
        ...
        {
            Debug.Log("Clearing marked static fields.");
            ...
            foreach (var fieldInfo in fieldInfos)
            {
                ...
                if (fieldInfo.GetCustomAttribute<ClearOnLoadAttribute>().Message != string.Empty)
                    Debug.Log($"Cleared field '{fieldInfo.Name}' in type '{fieldInfo.DeclaringType.Name}' message: {fieldInfo.GetCustomAttribute<ClearOnLoadAttribute>().Message}");
            }
        }
